...
import { useUpdateHotelMutation } from '../../store/api/hotelApi';
...
const EditHotelModal = ({ open, onClose, onSuccess, hotel }) => {
    ...
    // Инициализация формы данными отеля
    useEffect(() => {
        if (hotel) {
        reset({
            name: hotel.name || '',
    ...
    return (
        ...
        <DialogTitle>
            ...
            <Typography variant="h6">Редактировать отель</Typography>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {error && (
                ...
                {error.data?.message || 'Ошибка при обновлении отеля'}
                </Alert>
            )}
            ...
            {/* ДИАЛОГОВЫЕ ДЕЙСТВИЯ - ЭТУ ЧАСТЬ Я ПРОПУСТИЛ */}
            <DialogActions>
